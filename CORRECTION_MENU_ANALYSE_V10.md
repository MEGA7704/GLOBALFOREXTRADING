...
- Suppression des boutons dupliqués dans la carte d’analyse.
- Conservation des identifiants et événements existants afin de ne modifier ni l’analyse, ni les routes API, ni KV/D1, ni la sécurité.
- Menu adaptatif : horizontal sur grand écran et panneau compact accessible par le bouton menu sur tablette/mobile.
